...
app.post("/api/jsonToExcel", async (req, res) => {
  ...
  await workbook.xlsx.writeFile(__dirname + "/public/Generado/test.xlsx");

  fs.unlinkSync(__dirname + "/public/uploads/" + req.file.filename);

  var file = path.resolve("./public/Generado/test.xlsx");
  ...
  res.setHeader(
    "Content-disposition",
    "attachment; filename=excelGenerado.xlsx"
  );
                ...
                if (individuo === "A") {
                  ...
                  if (typeof elValor === "string") {
                    ...
                    aux =
                      ...
                      '"}}';
                    if (
                      elValor.toLowerCase() === "true" ||
                      elValor.toLowerCase() === "false"
                    ) {
